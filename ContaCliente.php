...
<body onunload="myfunction()">
  ...
  <div style="padding:2% 0 0; margin:0 auto;">
    <div class="CentralInfo">
      <h4 style="font-size: 25px;">Sua Conta</h4>
      <div class="Sub_CentralInfo">
        <button class="CaixaCentralInfo" id="#" href="#">
          <h4>Pedidos</h4>
        </button>
        <button class="CaixaCentralInfo" id="#" href="#">
          <h4>Segurança</h4>
        ...
        <button class="CaixaCentralInfo" id="SairConta">
          <h4><a style="text-decoration:none; color:white" href="./php/SairConta.php">Sair da conta</a></h4>
        </button>
      </div>
    </div>
  </div>
