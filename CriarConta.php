...
<body>
  ...
  <div class="Pagina_Criar_Conta ">
    <div class="form">
      <h2 style="font-family: roboto; margin-bottom: 10px;">Cadastrar</h2>
      <form class="form_registro" action="./php/CriarCliente.php" method="POST">
        <input type="hidden" name="insert">
        <div class="form_registro_1">
          <input type="email" name="txtEmail" placeholder="E-mail" />
          <input type="password" name="txtSenha" placeholder="Senha" />
          <input type="text" name="txtNome" placeholder="Nome" />
          <input type="text" name="txtSobrenome" placeholder="Sobrenome" />
          <input type="date" name="txtNascimento" placeholder="Data de nascimento" />
        </div>
        <button type="submit">Criar Conta</button>
        <p class="message">Já tem conta?<a href="Entrar.php"> Entrar</a></p>
      </form>
    </div>
  </div>
